...
<head>
    ...
    <link rel="stylesheet" href="<?=SITE_TEMPLATE_PATH?>/vendor/fonts/site-fonts.css">
    <link rel="stylesheet" href="<?=SITE_TEMPLATE_PATH?>/vendor/jquery-ui/1.12.1/themes/base/jquery-ui.min.css">
