...
$APPLICATION->SetPageProperty("description", "Гинекологическое оборудование и инструменты по цене от производителя с доставкой по РФ. 8-800-551-90-39 Звоните!");
$APPLICATION->SetTitle("Медицинская техника - прямые поставки от производителя");
?><div class="wrapper">
